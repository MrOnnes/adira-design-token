...
```js preview-story
export const exNavigation = () => html`
  <ul class="nav">
    <li class="nav-item">
  ...
  <ul class="nav nav-border nav-icon">
    ...
    <li class="nav-item">
      <a class=" nav-link  " href="#">
        <i class="fa-solid fa-user"></i>Page 2</a
      >
    </li>
    <li class="nav-item">
      <a class=" nav-link  " href="#">
        <i class="fa-solid fa-gear"></i>Page 3</a
      >
    </li>
    <li class="nav-item">
      <a class=" nav-link   disabled" href="#">
